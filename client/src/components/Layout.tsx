...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const NavLinks = () => (
    <nav className="flex flex-col gap-2">
      {isAdmin && (
        <Link href="/analytics" onClick={() => setOpenMobile(false)} className={`px-4 py-3 rounded-lg transition-colors duration-200 hover:bg-gray-100 dark:hover:bg-gray-800 ${
